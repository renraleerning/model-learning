...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        ...
        <div class="row">
                ...
                <div class="card">
                    ...
                    <div class="card-body">                  
                        <object class="flash-materi" width="750" height="600">
                            <param name="movie" value=" {{ asset('style/assets/minigames/linked_ddl_tipedata_number.swf' )}} ">
                            <embed src="{{ asset('style/assets/minigames/linked_ddl_tipedata_number.swf' )}}" width="550" height="400"></embed>
                        </object>
                    </div>
                </div>
            </div>
            <ul class="pagination">
                <li class="page-item">
                <a class="page-link" href="/materi/ddl/{{3}}" aria-label="Previous">
                ...
                <li class="page-item">
                <a class="page-link" href="/materi/ddl/{{5}}">
