                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Menanya materi DDL</a></li>                    
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="modalTinjau{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="modalTinjauTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                ...
                <p>{{$p->catatan}}</p>
                <form action="/tanya-revisi/ddl/{{$p->id}}" method="post" enctype="multipart/form-data">
                    @csrf                    
