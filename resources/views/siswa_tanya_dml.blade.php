                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="#!">Menanya materi DML</a></li>                    
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="height: 100px;">
                        <h3>List Status - Pertanyaan</h3>
                    </div>
                    <div class="card-body">
                        <p style="font-size: 12pt">
                            Tabel list status pertanyaan anda, yang telah diperiksa
                            oleh guru. Jika sudah benar, silahkan lanjut untuk membuat
                            prediksi mengenai materi dml.
                        </p>
    ...
    <div class="modal fade" id="modalTinjau{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="modalTinjauTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-header" style="background-color: #ecf0f1;">
                <h5 class="modal-title" id="modalTinjauLongTitle">Upload ulang pertanyaan</h5>                
            ...
            <div class="modal-body">
                ...
                <p>{{$p->catatan}}</p>
                <form action="/tanya-revisi/dml/{{$p->id}}" method="post" enctype="multipart/form-data">
                    @csrf                    
                    <label for="chooseFile" class=" form-control-label">Upload pertanyaan yang sudah dilengkapi :</label>
