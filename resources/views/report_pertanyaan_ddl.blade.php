                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Menanyakan materi DDL</h5>                            
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route('guru.dashboard') }}"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Report pertanyaan materi DDL</a></li>                    
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header" style="height: 100px;">
                        <h3>List Status - Report Pertanyaan DDL</h3>
                    </div>
                    <div class="card-body">
                        <p style="font-size: 12pt">
                            Tabel list report pertanyaan ddl yang telah di buat oleh siswa, Silahkan
    ...
    <div class="modal fade" id="modalTinjau{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="modalTinjauTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-body">
                <p>Silahkan unduh dokumen pertanyaan yang telah siswa upload !</p>
                <form action="/report-pertanyaan/ddl/{{$p->id}}" method="post">
                    @csrf
                    <div class="form-group">
                        <label for="catatan">Catatan pertanyaan :</label>
                    ...
                    <div class="form-group">
                        <label for="status">Status pertanyaan siswa :</label>
                        <select class="form-control" id="status" name="status" oninvalid="this.setCustomValidity('Mohon tentukan status nya !')" oninput="setCustomValidity('')" required>
                            <option value="" selected disabled>Pilih status pertanyaan</option>
