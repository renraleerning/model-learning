            ...
            <div class="col-sm-6 mx-auto">
                <div class="card">
                    <div class="card-header" style="height: 100px;">
						<h3>Rangkuman materi DML (<i>Data Definition Language</i>)</h3>
                    </div>
                    <div class="card-body">
                        <p style="font-size: 12pt">
                            Silahkan anda rangkum materi DML dari paparan text penjelasan
                            ...
                            Dengan format nama ('No.absen'_'Nama'_Rangkuman_dml)
                        </p>
                        <form action="/rangkum/dml/{{'dml'}}" method="post" enctype="multipart/form-data">
                            @csrf
